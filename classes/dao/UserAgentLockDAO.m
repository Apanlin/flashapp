...
+ (UserAgentLock*) getUserAgentLock:(NSString*)userAgent
{
    ...
    char* sql = "select locked, locktime, timeLength, resumetime from user_agent_lock where useragent = ?";
...
{
    sqlite3* conn = [DBConnection getDatabase];
    char* sql = "select useragent, locktime, timeLength, resumetime from user_agent_lock where locked = 1";
