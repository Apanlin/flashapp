...
-(void)renderInLayer:(CPTGraphHostingView *)layerHostingView withTheme:(CPTTheme *)theme
{
    ...
    afterLineStyle.lineColor = [CPTColor colorWithCGColor:[UIColor whiteColor].CGColor];
	...
	// Put an area gradient under the plot above
	areaColor = [CPTColor colorWithComponentRed:0.2 green:0.2 blue:0.2 alpha:0.5];
	...
	switch ( fieldEnum ) {
        ...
        case CPTScatterPlotFieldY:
            if ( plot.identifier == kBeforeLine ) {
                float f = [NSString bytesNumberByUnit:dayData.before unit:byteUnit];
