...
- (void) layoutSubviews
{
    ...
    iconView.frame = CGRectMake( 20, (self.frame.size.height - 15)/2, 15, 15);
    messageLabel.frame = CGRectMake( 45, 0, self.frame.size.width - 65, self.frame.size.height);
    indicatorView.frame = CGRectMake( 20, (self.frame.size.height - 15)/2, 15, 15);
}
