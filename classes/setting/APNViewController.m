...
{
    [cuButton setImage:[UIImage imageNamed:@"radio.png"] forState:UIControlStateNormal];
    [cmButton setImage:[UIImage imageNamed:@"radio.png"] forState:UIControlStateNormal];
    [ctButton setImage:[UIImage imageNamed:@"radio.png"] forState:UIControlStateNormal];
    selectedRadio = RADIO_DEFINE;
